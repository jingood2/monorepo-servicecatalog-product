...
export class ECSClusterProduct extends servicecatalog.ProductStack {
  constructor(scope: Construct, id: string, _props: ECSClusterProductProps) {
    ...
    // default ECS Cluster AutoScalingGroup automatically
    // Either add default capacity
    /* const defaultAsg = cluster.addCapacity('DefaultAutoScalingGroupCapacity', {
    ...
    //const jsonValue = ssm.StringParameter.fromStringParameterName(this,'AMI','/aws/service/ecs/optimized-ami/amazon-linux-2/recommended').stringValue;
