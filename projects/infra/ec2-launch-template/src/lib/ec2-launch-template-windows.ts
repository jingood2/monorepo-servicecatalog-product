...
export class EC2LaunchTemplateWinProduct extends ProductStack {
  constructor(scope: Construct, id: string, _props: EC2LaunchTemplateProps) {
    ...
    new ec2.LaunchTemplate(this, 'EC2WinLaunchTemplate', {
      launchTemplateName: 'WIN_2022_ENG_BASE_X86_64',
      instanceType: new ec2.InstanceType(instanceType.valueAsString),
      machineImage: ec2.MachineImage.latestWindows(ec2.WindowsVersion.WINDOWS_SERVER_2022_ENGLISH_CORE_BASE),
      //role: ec2Role,
