    ...
    const platformType = new cdk.CfnParameter(this, 'EBPlatformType', {
      ...
      allowedValues:
        [
          ...
          '64bit Amazon Linux 2 v3.1.4 running ECS',
          '64bit Amazon Linux 2 v2.3.4 running .NET Core',
          '64bit Windows Server 2019 v2.10.2 running IIS 10.0',
          '64bit Windows Server Core 2019 v2.10.2 running IIS 10.0',
          '64bit Windows Server 2016 v2.10.2 running IIS 10.0',
          '64bit Windows Server Core 2016 v2.10.2 running IIS 10.0',
          '64bit Windows Server 2012 R2 v2.10.2 running IIS 8.5',
          '64bit Windows Server Core 2012 R2 v2.10.2 running IIS 8.5',
          '64bit Amazon Linux 2 v5.5.5 running Node.js 16',
          '64bit Amazon Linux 2 v5.5.5 running Node.js 14',
          '64bit Amazon Linux 2 v3.4.0 running PHP 8.1',
          '64bit Amazon Linux 2 v3.4.0 running PHP 8.0',
          '64bit Amazon Linux 2 v3.3.16 running Python 3.8',
          '64bit Amazon Linux 2 v3.3.16 running Python 3.7',
        ],
    });
