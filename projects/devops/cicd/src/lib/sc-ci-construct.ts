...
export interface StackNameProps {
}

export class SCCIConstruct extends Construct {
  constructor(scope: Construct, id: string ) {
    ...
    const buildSpec = yaml.parse(fs.readFileSync(path.join(__dirname, './buildspec.v3.yml'), 'utf8'));
